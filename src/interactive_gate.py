...
user opening Zephyrus, Cookbook, email, documents, notes, or other panels.
"""
...
def _browser_active_seconds() -> float:
    """How long a visible Zephyrus browser heartbeat blocks background tasks."""
    try:
...
async def mark_browser_activity() -> None:
    """Record that an authenticated browser tab is visibly using Zephyrus."""
